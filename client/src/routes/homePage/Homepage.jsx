...
const HomePage = () => {
  ...
  return (
    <div className="row homepage pt-3 pt-md-0">
      <div className="col-12 col-md-7 my-sm-auto h-25 h-sm-auto mt-3">
      ...
      <div className="col-12 col-md-5 h-25 h-sm-auto d-flex justify-content-center align-items-center">
