            ...
            >
              <ul className="navbar-nav align-items-center w-100 gap-sm-3 justify-content-around  pt-3 pt-sm-0 justify-content-sm-end flex-grow-1">
                ...
                <Link onClick={handleLogout}>
                  <li className={`nav-item px-3 `}>
                    <div
                      className={`d-block d-sm-none phone-nav-item d-flex justify-content-center align-items-center flex-column`}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="28.5"
                      ...
                      <p className="text-center small-text mb-1">Logout</p>
                    </div>
                    <div
